package com.birtu.oj.allsearch.nai.util;

import com.birtu.oj.allsearch.nai.entry.node.Tags;
import com.birtu.oj.allsearch.nai.io.ToDictionaryIO;
import com.birtu.oj.allsearch.nai.repository.AlgorithmCql;
import com.birtu.oj.allsearch.nai.repository.ProblemCql;
import com.birtu.oj.allsearch.nai.service.neo.AlgorithmService;
...
class toDictionaryIOTest {
    ...
    void outAlgorithm() {
        ...
        List<com.birtu.oj.allsearch.nai.entry.node.Tags> all = algorithmCql.getAll();
